...
def get_credentials_from_google(code: str):
    client_id = "109066387563-ssbpapni2egmjl54p1vgfpb4qjhi0g3c.apps.googleusercontent.com"
    ...
    # )
    id_token, token_expiry = google.oauth2.id_token.verify_oauth2_token(id_token=code,request=google.auth.transport.requests.Request(), audience=client_id)
